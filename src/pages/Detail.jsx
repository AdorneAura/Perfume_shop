...
import detailIcons from '../components/Detail/icons'
import DetailIcon from '../components/Detail/DetailIcon'
...
const Detail = () => {
  ...
  const addProductToCart = () => {
    ...
    setTimeout(() => {
      dispatch(
        addToCart({ documentId: item.id, variationKey, quantity, product })
      )
  ...
  return (
    <div className='flex flex-col lg:flex-row items-start gap-10 px-6 py-8'>
      {product ? (
        <>
